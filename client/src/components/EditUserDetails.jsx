...
const EditUserDetails = ({onClose,user}) => {
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 bg-gray-700 bg-opacity-40 flex justify-center items-center z-10 font-semibold'>
        <div className='bg-white p-4 py-6 m-1 rounded w-full max-w-sm'>
            <h2 className='font-bold'>Edit User Details</h2>
